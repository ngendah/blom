...
class TrainAndTestTester : public ::testing::Test {
 public:
  ...
  std::string dataset_root_directory_ = "testing_data/dataset";
  ...
  std::string preferred_format_type = "csv";
  std::string preferred_format_extension = ".csv";
...
void ExpectEqualPredictionsTemplate(const dataset::VerticalDataset& dataset,
  ...
  const auto dataset_as_example_set = serving::VerticalDatasetToExampleSet(dataset,
                                                                       engine)
          .value();
